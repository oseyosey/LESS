...
if [[ $accelerate_launch == "true" ]]; then
    header="accelerate launch --config_file /share/kuleshov/jy928/compute_optimal_data_selection/LESS/scripts/accelerate_config/multi_gpu${number_of_gpus}.yaml less/train/train.py"
fi
